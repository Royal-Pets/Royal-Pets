          ...
          <Carousel className="slide-show">
            <Carousel.Item>
              ...
              <Carousel.Caption>
                ...
                <p>
                  Whether it's a quick question over the phone or a
                  second-opinion consultation, we're here & waiting
                </p>
              </Carousel.Caption>
            </Carousel.Item>
            <Carousel.Item>
              ...
              <Carousel.Caption>
                ...
                <p>
                  Health care from your pet's point of view means we treat your
                  pet as you would like to be treated yourself
                </p>
              </Carousel.Caption>
            </Carousel.Item>
            <Carousel.Item>
              ...
              <Carousel.Caption>
                ...
                <p>
                  Ask about our competitively priced vaccinations, desexes and
                  wellness dentals
                </p>
              </Carousel.Caption>
            </Carousel.Item>
        ...
        <div className="homeMainBody">
          ...
          <div className="homeAboutUs">
            ...
            <div className="homeAboutUsText">
              ...
              <p>
                Since our launch in 1986, we transfer in dogs and cats from
                public shelters where they are in danger of being euthanized due
                to space or financial limitations. We then provide them with the
                best possible care and enrichment until we can help them find
                their forever homes.
              </p>
              <Link to="/about">
                <button
          ...
          <div className="ourPros">
            <div>
              ...
              <h2>Our Values</h2>
              <p>
                Everything we do at Royal-Pets – from the way we greet you on
                the phone, to the way we introduce a new service or train a new
                team member, is underpinned by the following seven core values:
            ...
            <div>
              ...
              <h2>Our Vision</h2>
              <p>
                5 years from now, Pet Universe will be the ultimate professional
                veterinary practice that combines excellent healthcare delivered
                in a consistent, innovative, enjoyable, caring and pet-friendly
                way to create a value-for-money yet profitable and unforgettable
                service experience from our:
                <br></br>★ Pet’s Point of View ★ Client’s Point of View ★
                Staff’s point of view ★ Platinum Partner’s Point Of View ★
